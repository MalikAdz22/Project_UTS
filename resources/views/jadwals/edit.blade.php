    ...
    <div class="card-body">
        ...
        <form action="{{ route('jadwals.update', $jadwal->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control @error('tanggal_seleksi') is-invalid @enderror" id="tanggal_seleksi" name="tanggal_seleksi" value="{{ old('tanggal_seleksi', $jadwal->tanggal_seleksi->format('Y-m-d')) }}" required>
